...
@section('content')
    {!! Form::open([ 'route' => [ 'language.edit', $get['id'] ], 'class' => 'kt-form kt-form--label-right']) !!}
        <div class="kt-portlet__body">
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-9">
                    {{ Form::text('code', $get['code'], [ 'class' => 'form-control']) }}
                </div>
            </div>
            <div class="form-group row">
                <label class="col-lg-3 col-form-label">Öncelik:</label>
                <div class="col-lg-9">
                    {{ Form::text('priority', $get['priority'], [ 'class' => 'form-control']) }}
                </div>
            </div>
        </div>
