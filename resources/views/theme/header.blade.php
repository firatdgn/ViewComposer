        <section class="header-content">
            ...
            <div class="owl-slider">
                ...
                <div class="item" style="background-image:url({{ asset('assets/images') }}/gallery-1.jpg)">
                    <div class="box">
                        <div class="container">
                ...
                <div class="item" style="background-image:url({{ asset('assets/images') }}/gallery-2.jpg)">
                    <div class="box">
                        <div class="container">
                ...
                <div class="item" style="background-image:url({{ asset('assets/images') }}/gallery-3.jpg)">
                    <div class="box">
                        <div class="container">
